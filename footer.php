...
<div id="side-contact" class="float-btn">
    <a href="https://wa.me/60124226899" id="whatsapp-float" class="floating-button floating-button_whatsapp" target="_blank"><i id="whatsapp-float" class="fa-brands fa-whatsapp"></i></a>
    <a href="tel:60124226899" id="tel-float" class="floating-button floating-button_phone" target="_blank"><i id="tel-float" class="fa-solid fa-phone"></i></a>
    <a href="mailto:info@amindo.com.my" id="email-float" class="floating-button floating-button_mail	popmake-293" target="_blank"><i id="email-float" class="fa-solid fa-envelope"></i></a>
